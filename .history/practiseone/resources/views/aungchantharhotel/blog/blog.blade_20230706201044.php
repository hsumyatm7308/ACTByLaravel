	...
	<div id="wrapper">
		...
		<div id="main">
			...
			<article class="post">
				...
				<a href="{{route('fstpost')}}" class="image featured"><img src="https://source.unsplash.com/random/500x300?1" alt="" /></a>
				...
				<footer>
					<ul class="actions">
						<li><a href="{{route('fstpost')}}" class="button large">Continue Reading</a></li>
					</ul>
					<ul class="stats">
