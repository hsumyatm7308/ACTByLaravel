	...
	<div id="wrapper">
		...
		<div id="main">
			...
			<article class="post">
				<header>
					...
					<div class="meta">
						...
						<a href="#" class="author"><span class="name">Jane Doe</span><img src="{{asset('blog/aungchanthar/assets/img/users/user1.png')}}"
								alt="" /></a>
					</div>
				</header>
				<a href="single.html" class="image featured"><img src="{{asset('aungchanthar/images/pic01.jpg')}}" alt="" /></a>
			...
			<article class="post">
				...
				<a href="single.html" class="image featured"><img src="{{asset('aungchanthar/images/pic02.jpg')}}" alt="" /></a>
				<p>Mauris neque quam, fermentum ut nisl vitae, convallis maximus nisl. Sed mattis nunc id lorem euismod
					placerat. Vivamus porttitor magna enim, ac accumsan tortor cursus at. Phasellus sed ultricies mi non
			...
			<article class="post">
				...
				<a href="single.html" class="image featured"><img src="{{asset('aungchanthar/images/pic03.jpg')}}" alt="" /></a>
				<p>Mauris neque quam, fermentum ut nisl vitae, convallis maximus nisl. Sed mattis nunc id lorem euismod
					placerat. Vivamus porttitor magna enim, ac accumsan tortor cursus at. Phasellus sed ultricies mi non
					congue ullam corper. Praesent tincidunt sed tellus ut rutrum. Sed vitae justo condimentum, porta
				...
				<div class="mini-posts">
					...
					<article class="mini-post">
						<header>
							...
							<a href="#" class="author"><img src="{{asset('aungchanthar/images/avatar.jpg')}}" alt="" /></a>
						</header>
						<a href="single.html" class="image"><img src="{{asset('aungchanthar/images/pic04.jpg')}}" alt="" /></a>
					</article>
					...
					<article class="mini-post">
						...
						<a href="single.html" class="image"><img src="{{asset('aungchanthar/images/pic05.jpg')}}" alt="" /></a>
					</article>
					...
					<article class="mini-post">
						...
						<a href="single.html" class="image"><img src="{{asset('aungchanthar/images/pic06.jpg')}}" alt="" /></a>
					</article>
					...
					<article class="mini-post">
						...
						<a href="single.html" class="image"><img src="{{asset('aungchanthar/images/pic07.jpg')}}" alt="" /></a>
					</article>
				...
				<ul class="posts">
					<li>
						<article>
							...
							<a href="single.html" class="image"><img src="{{asset('aungchanthar/images/pic08.jpg')}}" alt="" /></a>
						</article>
					</li>
					<li>
						<article>
							...
							<a href="single.html" class="image"><img src="{{asset('aungchanthar/images/pic09.jpg')}}" alt="" /></a>
						</article>
					</li>
					<li>
						<article>
							...
							<a href="single.html" class="image"><img src="{{asset('aungchanthar/images/pic10.jpg')}}" alt="" /></a>
						</article>
					</li>
					<li>
						<article>
							...
							<a href="single.html" class="image"><img src="{{asset('aungchanthar/images/pic11.jpg')}}" alt="" /></a>
						</article>
					</li>
					<li>
						<article>
							...
							<a href="single.html" class="image"><img src="{{asset('aungchanthar/images/pic12.jpg')}}" alt="" /></a>
						</article>
					</li>
				</ul>
			</section>
