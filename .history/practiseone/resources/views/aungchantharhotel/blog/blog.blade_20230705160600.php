...
<html>
    <head>
        ...
        <link href="{{asset('blog/aungchanthar/assets/libs/magnific-popup-master/dist/magnific-popup.css')}}" rel="stylesheet" type="text/css"/>
        <!-- custom css -->
        <!-- <link href="./css/style.css" rel="stylesheet" type="text/css"/> -->
        <link href="{{asset('blog/aungchanthar/css/style.css')}}" rel="stylesheet" type="text/css"/>
