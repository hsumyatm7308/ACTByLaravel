...
@extends('aungchantharhotel/blog/singlelayout')

@section('title','MAGNA SED ADIPISCING')
					...
					<div id="main">
						...
						<!-- Post -->
							<article class="post">
								<header>
									<div class="title">
										<h2><a href="#"></a>@section('ptitle2','Ultricies sed magna euismod enim vitae gravida') </h2>
