...
<!-- Scripts -->
<script src="{{asset('blog/aungchanthar/assets/js/jquery.min.js')}}"></script>
<script src="{{asset('blog/aungchanthar/assets/js/browser.min.js')}}"></script>
<script src="{{asset('blog/aungchanthar/assets/js/breakpoints.min.js')}}"></script>
<script src="{{asset('blog/aungchanthar/assets/js/util.js')}}"></script>
<script src="{{asset('blog/aungchanthar/assets/js/main.js')}}"></script>
