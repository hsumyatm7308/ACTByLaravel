...
Route::get('aungchantharhotel/blog/singlelayout/postone',[App\Http\Controllers\postController::class,'post'])->name('fstpost');
Route::get('aungchantharhotel/blog/singlelayout/postwo',[App\Http\Controllers\posttwoController::class,'posttow'])->name('secpost');