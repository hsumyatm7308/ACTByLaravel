...
Route::get('aungchantharhotel/blog/singlelayout/post',[App\Http\Controllers\postController::class,'post'])->name('fstpost');
Route::get('aungchantharhotel/blog/singlelayout/post',[App\Http\Controllers\posttwoController::class,'posttow'])->name('secpost');