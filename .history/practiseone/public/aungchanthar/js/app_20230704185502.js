...
getheader.style.backgroundImage = `url("{{asset('aungchantharhotel/assets/img/banner/banner')}}${getgen.next().value}.jpg")`;


function autoload(){
    // console.log(getgen.next().value);
    // getheader.style.backgroundImage = `url("./assets/img/banner/banner${getgen.next().value}.jpg")`;
    getheader.style.backgroundImage = `url("{{asset('aungchanthar/assets/img/banner/banner')}}${getgen.next().value}.jpg")`;
}
